        ...
        <div class="well">
            <form role="form" action="{{$modify==1 ? route('updatePost',['post'=>$post->id]) : route('addPost')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group center">
                    ...
                    <input class="form-control" id="title" type="text" name="title" value="{{$modify==1 ? $post->title : old('title')}}"/>
                    @if ($errors->has('title'))
                    ...
                    <input class="form-control" id="price" type="text" name="price" value="{{$modify==1 ? $post->price : old('price')}}"/>
                    @if ($errors->has('price'))
                        <span class="help-block error">
                    ...
                    <input class="form-control" id="quantity" type="text" name="quantity" value="{{$modify==1 ? $post->quantity : old('quantity')}}"/>
                    ...
                    <textarea class="form-control postBody" id="detail" name="detail" rows="7">{{$modify==1 ? $post->detail : old('detail')}}</textarea>
